...
const Menu = () => {
  ...
  // Filtered menus based on search and preference
  const filteredMenus = menus.filter((menu) => {
    const matchesSearch = menu.name
      .toLowerCase()
      .includes(searchTerm.toLowerCase());
    const matchesPreference =
      preferenceFilter === "All" || menu.preference === preferenceFilter.toLowerCase();
    ...
    <div className="p-6 bg-gray-50 min-h-screen pt-20">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-8">
        <input
          ...
          className="w-full sm:w-1/2 px-4 py-2 border rounded-lg shadow-sm focus:ring-2 focus:ring-orange-400 focus:border-orange-400 transition"
        />

        <select
          value={preferenceFilter}
          onChange={(e) => setPreferenceFilter(e.target.value)}
          className="w-full sm:w-1/4 px-4 py-2 border rounded-lg shadow-sm focus:ring-2 focus:ring-orange-400 focus:border-orange-400 transition"
        >
          ...
          {filteredMenus.map((menu) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <p className="text-lg font-semibold text-gray-800 mb-4">Rs {menu.price}</p>
                <button
